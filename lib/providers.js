...
apt-get install -y nginx mysql-server php-fpm php-mysql unzip

# Configura MySQL (Cria banco e usuário)
mysql -e "CREATE DATABASE wordpress DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;"
mysql -e "CREATE USER 'wpuser'@'localhost' IDENTIFIED BY 'wp_password_secure_123';"
