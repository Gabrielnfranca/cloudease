    ...
    <style>
        ...
        * { box-sizing: border-box; }
        body {
            ...
            color: var(--text);
            background:
                radial-gradient(circle at 15% 15%, rgba(10,108,253,0.22), transparent 32%),
                radial-gradient(circle at 80% 85%, rgba(15,157,88,0.16), transparent 30%),
    ...
    <main class="card">
        <section class="header">
            ...
            <div class="title-wrap">
                <h1>Ambiente em Producao</h1>
                <p class="subtitle">Seu servidor foi provisionado com sucesso pela <strong>CloudEase</strong>. Você já pode subir os arquivos finais do projeto.</p>
            </div>
        </section>

        <div class="status"><i class="fas fa-circle-check"></i> Provisionamento concluído</div>
        ...
        <section class="hint">
            ...
            <strong>Próximo passo:</strong> envie os arquivos do site via SFTP para substituir este arquivo <strong>index.php</strong>.
            Assim que um <strong>index.html</strong> existir, ele será exibido automaticamente.
        </section>
    </main>
</body>
</html>
