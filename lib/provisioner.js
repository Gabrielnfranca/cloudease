...
<style>
    ...
    *{box-sizing:border-box}
    ...
    .main{padding:12px}
    .toolbar{display:flex;gap:8px;flex-wrap:wrap;align-items:center;background:#fff;border:1px solid var(--line);padding:10px;border-radius:10px}
    ...
    @media (max-width:900px){.shell{grid-template-columns:1fr}.sidebar{border-right:none;border-bottom:1px solid var(--line)}}
</style></head><body>
<div class="topbar">
...
<div class="shell">
    ...
    <main class="main">
        <form class="toolbar" method="post" enctype="multipart/form-data">
            ...
            <a class="btn gray" href="?path=<?=urlencode($rel)?>&view=grid">Grade</a>
            <a class="btn gray" href="?path=<?=urlencode($rel)?>&view=list">Detalhes</a>
        </form>
