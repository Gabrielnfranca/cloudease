...
error_handler() {
    local line=$1
    log "ERROR: Falha na linha $line"
    echo "ERROR:Falha na linha $line" >> $LOG_FILE
}
...
if ! command -v php &> /dev/null; then
    ...
    apt-get update -qq && apt-get install -y php-cli php-fpm php-mysql mariadb-client unzip || true
fi
