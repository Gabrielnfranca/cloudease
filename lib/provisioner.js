...
<style>
    ...
    *{box-sizing:border-box}
    ...
    .breadcrumb-bar{background:#fff;border-bottom:1px solid var(--line);padding:12px 16px;display:flex;align-items:center;gap:10px;font-size:13px;min-height:40px}
    ...
    @media (max-width:900px){.toolbar{flex-direction:column;align-items:stretch}.toolbar-left,.toolbar-right{width:100%}.breadcrumb-bar{padding:10px 12px;font-size:12px}.main{padding:16px}}
</style></head><body>
<div class="topbar">
