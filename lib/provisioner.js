...
if (empty($_SESSION['fm_auth'])) {
    ...
    <form class="card" method="post"><h3>Gerenciador de Arquivos</h3><p style="font-size:13px;color:#64748b">Use as credenciais do banco de dados deste site.</p><?php if(!empty($error)) echo '<p class="err">'.esc($error).'</p>'; ?><input name="user" placeholder="Usuario" required><input name="pass" type="password" placeholder="Senha" required><button>Entrar</button></form>
    </body></html>
    <?php
    exit;
}
