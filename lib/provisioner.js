...
<body>
    <main class="card">
        ...
        <section class="hint">
            ...
            <div class="actions">
                <a class="btn-db" href="/adminer.php" target="_blank" rel="noopener">
...
HTMLEOF
    ...
    # Instala Adminer para acesso web ao banco com os usuarios criados no projeto
    if [ ! -f adminer.php ]; then
        log "Instalando Adminer..."
        curl -fsSL -o adminer.php https://github.com/vrana/adminer/releases/download/v4.8.1/adminer-4.8.1.php || \
        wget -q -O adminer.php https://github.com/vrana/adminer/releases/download/v4.8.1/adminer-4.8.1.php || true
    fi
