...
export async function provisionWordPress(serverIp, domain, wpConfig = null) {
    return new Promise((resolve, reject) => {
        ...
        let commands = [
            ...
            // Instalar Redis se solicitado
            (wpConfig && wpConfig.cache === 'redis') ? 'apt-get install -y redis-server php-redis && systemctl enable redis-server && systemctl start redis-server' : 'echo "Redis não solicitado"',
