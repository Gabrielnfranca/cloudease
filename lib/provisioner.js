...
<style>
    ...
    *{box-sizing:border-box}
    ...
    @media (max-width:900px){.toolbar{flex-direction:column;align-items:stretch}.toolbar-left,.toolbar-right{width:100%}.breadcrumb-bar{padding:8px 10px;font-size:12px}}
</style></head><body>
<div class="topbar">
