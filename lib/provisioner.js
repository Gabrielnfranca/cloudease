...
export async function provisionSSL(serverIp, domain) {
    ...
    // Comando para tentar obter o certificado
    const cmd = `certbot --nginx -d ${domain} --non-interactive --agree-tos -m ${email} --redirect`;

    // Verifica se certbot existe, se não instala
    const installCertbot = 'if ! command -v certbot &> /dev/null; then apt-get update && apt-get install -y certbot python3-certbot-nginx; fi';

    return executeCommand(serverIp, `${installCertbot} && ${cmd}`);
}

 / * * 
   *   I n s t a l a   S S L   v i a   C e r t b o t   ( L e t ' s   E n c r y p t ) 
   * / 
 e x p o r t   a s y n c   f u n c t i o n   p r o v i s i o n S S L ( s e r v e r I p ,   d o m a i n )   { 
         c o n s t   e m a i l   =   \  d m i n @ \ \ ;   
         / /   T e n t a t i v a   d e   S S L   l i m p o : 
         / /   1 .   G a r a n t i r   q u e   N g i n x   e s t �   r o d a n d o   e   a c e s s � v e l   n a   p o r t a   8 0 
         / /   2 .   E x e c u t a r   c e r t b o t   - - n g i n x 
         
         / /   C o m a n d o   p a r a   t e n t a r   o b t e r   o   c e r t i f i c a d o 
         c o n s t   c m d   =   \ c e r t b o t   - - n g i n x   - d   \   - - n o n - i n t e r a c t i v e   - - a g r e e - t o s   - m   \   - - r e d i r e c t \ ; 
 
         / /   V e r i f i c a   s e   c e r t b o t   e x i s t e ,   s e   n � o   i n s t a l a 
         c o n s t   i n s t a l l C e r t b o t   =   ' i f   !   c o m m a n d   - v   c e r t b o t   & >   / d e v / n u l l ;   t h e n   a p t - g e t   u p d a t e   & &   a p t - g e t   i n s t a l l   - y   c e r t b o t   p y t h o n 3 - c e r t b o t - n g i n x ;   f i ' ; 
 
         r e t u r n   e x e c u t e C o m m a n d ( s e r v e r I p ,   \ \   & &   \ \ ) ; 
 } 
 
 
 