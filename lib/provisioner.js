...
export async function provisionWordPress(serverIp, domain, wpConfig = null) {
    return new Promise((resolve, reject) => {
        ...
        // Senha SFTP - Vamos usar o mesmo nome do DBUser para o User do sistema, ou parecido
        // Limitando a 32 caracteres para user linux
        const sysUser = dbName; 
        const sysPass = Math.random().toString(36).slice(-10) + 'S' + Date.now().toString().slice(-4);
